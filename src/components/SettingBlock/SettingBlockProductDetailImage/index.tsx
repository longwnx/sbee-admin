...
import { IconClose, OpenImageLibrary, SettingActionBlock, SettingOpenCategory } from '@/components'
...
export const SettingBlockProductDetailImage: React.FC<Props> = ({ setIsVisible }) => {
  ...
  const onSave = useCallback(
    ...
    [categories, action, images, onUpdateBlockItem, setIsVisible, setCurrentIndexBlock]
  )
