...
export const SettingScreenCategories: React.FC<Props> = () => {
      ...
      <Scrollbars className="h-full flex-1">
        <div className="h-full flex flex-col px-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <Typography.Paragraph className="mb-0 flex items-center gap-1">Show product search bar</Typography.Paragraph>
            <Switch
